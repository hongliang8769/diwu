...
$("#windowcenter").fadeIn("slow"); 
$("#txt").html(title);
//$("#windowcenter").hide("slow"); 
//setTimeout('$("#windowcenter").fadeOut(500)',5000);
} 
function alerturl(title,url){  
$("#windowcenter").fadeIn("slow"); 
$("#txt").html(title);
//$("#windowcenter").hide("slow"); 
//$("#windowcenter").fadeOut(500,function(){location.href=url;});
$("#windowclosebutton,#alertclose").click(function () { 
$("#windowcenter").fadeOut(300,function(){location.href=url;});
});
} 
function alertshow(title,obj){  
$("#windowcenter").fadeIn("slow"); 
$("#txt").html(title);
//$("#windowcenter").hide("slow"); 
//$("#windowcenter").fadeOut(500,function(){location.href=url;});
$("#windowclosebutton,#alertclose").click(function () { 
$("#windowcenter").fadeOut(300,function(){$('#'+obj).show('normal');});
});
}
