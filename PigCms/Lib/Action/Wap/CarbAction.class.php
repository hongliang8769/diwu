<?php
class CarbAction extends WapAction{
	public $wecha_id;
	public $thisUser;
	public $isamap;
	public function __construct(){
		...
		if (!$this->wecha_id){//wecha_id不是查询Userinfo表后的结果进行的判断。
			$this->error('您没有权限使用会员卡，如需使用请关注微信“'.$this->wxuser['wxname'].'”并回复微车管家',U('Index/index',array('token'=>$this->token)));
		}
	...
	public function bang(){
		...
		$signPackage = $actoken->GetSignPackage();
