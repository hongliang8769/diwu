...
.pages .disabled{border:#eee 1px solid;padding:2px 5px;margin:2px;color:#ddd;}
 ...
 <?php if(session('isQcloud') == true): ?><link type="text/css" rel="stylesheet" href="<?php echo ($staticPath); echo ltrim(RES,'.');?>/css/wxcloud.min.css" />
...
<div class="topbg">
  <div class="top">
    <div class="toplink">
      <style>
<?php if($usertplid == 1): ?>.topbg{background:url(<?php echo ($staticPath); ?>/tpl/static/newskin/images/top.gif) repeat-x; height:31px; /*box-shadow:0 0 10px #000;-moz-box-shadow:0 0 10px #000;-webkit-box-shadow:0 0 10px #000;*/}
.top {
    margin: 0px auto; width: 988px; height: 31px;
}
...
.nbanner{ background: url(img/h2003070130.jpg) center no-repeat #ffca22;}<?php endif; ?>
      ...
      <div class="memberinfo"  id="destoon_member">
        <?php if($_SESSION[uid]==false): ?><a href="<?php echo U('Index/login');?>">登录</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="<?php echo U('Index/login');?>">注册</a>
          <?php else: ?>
          <a href="<?php echo U('User/Index/index');?>">管理中心</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          你好,<a href="/#" hidefocus="true"  ><span style="color:red"><?php echo (session('uname')); ?></span></a>（uid:<?php echo (session('uid')); ?>） <a href="/#" onclick="Javascript:window.open('<?php echo U('System/Admin/logout');?>','_blank')" >退出</a><?php endif; ?>
      </div>
    </div>
  </div>
</div>
...
a.nav-header{background:url("<?php echo ($f_siteUrl); ?>/tpl/static/images/arrow_click.png") center right no-repeat;cursor:pointer}
a.nav-header-current{background:url("<?php echo ($f_siteUrl); ?>/tpl/static/images/arrow_unclick.png") center right no-repeat;}
</style>
<?php
} ?>
