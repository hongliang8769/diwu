 ...
 <div class="contentmanage">
    <div class="developer">
      ...
      <div class="tableContent">
        ...
        <li class=" subCatalogList "> <a class="secnav_10" href="<?php echo U('Sms/index');?>">数据库维护</a> </li>
            </ul>
          </div>
        </div>
...
<div class="clr"></div>
        ...
        <div class="clr"></div>
          ...
          <?php else: ?>
            ...
            <a onclick="showApiInfo(<?php echo ($vo["id"]); ?>,'<?php echo ($vo["wxname"]); ?>')" href="javascript:void(0);" class="btnGreens" >API接口</a><?php endif; ?>
