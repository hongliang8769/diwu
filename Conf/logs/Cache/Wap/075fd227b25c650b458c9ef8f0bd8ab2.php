...
<div id="sharemcover" onclick="document.getElementById(&#39;sharemcover&#39;).style.display=&#39;&#39;;" style=" display:none">
    <img src="./style11_files/MgnnofmleM.png"></div>
<div class="top_bar" style="-webkit-transform:translate3d(0,0,0)">
    <nav>
        <ul id="top_menu" class="top_menu">
            <li><a onclick="javascript:displayit('')" href=""><img src="tpl/User/default/common/images/photo/plugmenu6.png"><label>首页</label></a></li>
            <li><a onclick="javascript:displayit('')" href=""><img src="tpl/User/default/common/images/photo/plugmenu20.png"><label>娱乐</label></a></li>
            <li><a onclick="javascript:displayit('')" href=""><img src="tpl/User/default/common/images/photo/plugmenu9.png"><label>商城</label></a></li>
            <li><a onclick="javascript:displayit('')" href=""><img src="tpl/User/default/common/images/photo/plugmenu21.png"><label>能量</label></a></li>
            <li><a onclick="javascript:displayit('')" href=""><img src="tpl/User/default/common/images/photo/plugmenu2.png"><label>我的</label></a></li>
        </ul>
    </nav>
</div>
